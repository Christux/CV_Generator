    ...
    def start_cli(self, argv: list[str] | None = None) -> None:
        ...
        try:
            ...
            if args.dev_server:
                ...
                self.app_config.dev_server = True
        ...
        try:
            ...
            if args.build:
                ...
                pg = PageGenerator(app_config=self.app_config)
                pg.build_page()
            ...
            if args.dev_server:
                ...
                pg.build_page()
                server = DevServer(
                    app_config=self.app_config, page_generator=pg)

                if args.open_browser:
                    webbrowser.open(self.app_config.page_url)

                server.serve()

        except Exception as e:
            print('Sorry, something went wrong when starting the build')
            print(e)
            print(type(e))
